...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        /// <summary>
        /// Get the VB analyzer being tested - to be implemented in non-abstract class.
        /// </summary>
        /// <returns>
        /// A new instance of the VB analyzer being tested.
        /// </returns>
        ...
        /// <summary>
        /// Called to test a VB <see cref="DiagnosticAnalyzer"/> when applied on the single input source as a string.
        /// <note type="note">
        /// <para>Input a <see cref="DiagnosticResult"/> for the expected <see cref="Diagnostic"/>.</para>
        /// </note>
        /// </summary>
        ...
        {
            return this.VerifyBasicDiagnosticAsync(source, new[] { expected }, cancellationToken);
        }
        ...
        /// <summary>
        /// Called to test a VB <see cref="DiagnosticAnalyzer"/> when applied on the input strings as sources.
        /// <note type="note">
        /// <para>Input a <see cref="DiagnosticResult"/> for each <see cref="Diagnostic"/> expected.</para>
        /// </note>
        /// </summary>
